...
export default function Estado404() {
                        ...
                        <Card.Body>
                            ...
                            <div className="d-flex justify-content-between align-items-end mb-4">
                                <h1 className="display-7 fw-bold">
                                    <div className="square-icon bg-warning text-black">
                            ...
                            <p className="mt-3 text-black fs-5">
                                <b>Descripción:</b> La página que estás buscando no ha sido
                                encontrada. La URL que ingresaste puede estar incorrecta, la
                                página puede haber sido movida a una nueva ubicación, o puede
